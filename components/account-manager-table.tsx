...
export function AccountManagerTable({
  ...
  const [activeDialogTab, setActiveDialogTab] = useState("action");
  ...
  const getStatusBadge = (status?: AlertStatus) => {
    switch (status) {
      case "yet-to-be-called":
        return <Badge variant="outline">Yet to be called</Badge>;
      case "re-engaged":
        return (
  ...
  const handleActionSubmit = () => {
    ...
    switch (selectedAction) {
      ...
      case "no-answer":
        ...
        updates.retryCount = (selectedAlert.retryCount || 0) + 1;
        break;
      case "needs-support":
  ...
  const activeAlerts = alerts.filter(
    (alert) =>
      !alert.acknowledged &&
      (alert.status === "yet-to-be-called" || !alert.status),
  );
  const inProgressAlerts = alerts.filter(
    (alert) =>
      alert.status &&
      alert.status !== "yet-to-be-called" &&
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Account Manager Dashboard</CardTitle>
        </CardHeader>
        <CardContent>
                ...
                {alerts.map((alert) => {
                  ...
                  return (
                    <TableRow key={alert.id}>
                      ...
                      <TableCell>
                        <Badge
                          variant={getRiskBadgeVariant(merchant?.riskLevel)}
                        >
                          {getRiskLevelText(merchant?.riskLevel)}
                        </Badge>
                      </TableCell>
                        ...
                        <div className="flex items-center gap-2">
                          <Dialog>
                            ...
                            <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden">
                              <DialogHeader>
                                <DialogTitle>
                                  Alert Management - {alert.merchantName}
                                </DialogTitle>
                                <DialogDescription>
                                  Manage alert and view merchant details
                                      ...
                                      >
                                        ...
                                        <SelectContent>
                                          ...
                                          <SelectItem value="needs-support">
                                            Needs Support / Pricing and Bill
                                            Change
                                          </SelectItem>
                                    ...
                                    {selectedAction === "will-return-later" && (
                                      <div className="space-y-3">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                          ...
                                          treated as "No Answer" with retry
                                          cycles.
                                        </p>
